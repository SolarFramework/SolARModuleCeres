...
namespace CERES {
    ...
    double SolARBundlerCeres::localBundleAdjustment(CamCalibration & K,
                                    CamDistortion & D,
    ...
    double SolARBundlerCeres::globalBundleAdjustment(CamCalibration & K,
                                    CamDistortion & D) {
