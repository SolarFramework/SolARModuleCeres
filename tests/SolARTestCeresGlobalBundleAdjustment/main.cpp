...
int main(int argc, char ** argv) {
	...
	const std::string path_config = "SolARTestCeresGlobalBundleAdjustment_conf.xml";
    ...
    while (true) {
        if (viewer3DPoints->display(pointCloudBefore, keyframePosesBefore[0], keyframePosesBefore, {}, refPointCloud, keyframePosesAfter) == FrameworkReturnCode::_STOP) {
			break;
        }
    }
